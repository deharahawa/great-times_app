...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference('Avaliacao.count') do
      post avaliacaos_url, params: { avaliacao: { avaliacao_texto: @avaliacao.avaliacao_texto } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { avaliacao_texto: @avaliacao.avaliacao_texto } }
