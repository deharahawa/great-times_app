...
class InstrumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrumento" do
    assert_difference('Instrumento.count') do
      post instrumentos_url, params: { instrumento: { nome_instrumento: @instrumento.nome_instrumento } }
    end
  ...
  test "should update instrumento" do
    patch instrumento_url(@instrumento), params: { instrumento: { nome_instrumento: @instrumento.nome_instrumento } }
